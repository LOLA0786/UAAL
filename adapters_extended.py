...
def _make_base(actor_id="agent:unknown", actor_type="agent", display_name=None):
    return {
        ...
        "actor": {"id": actor_id, "type": actor_type, "display_name": display_name or actor_id},
...
def openai_assistant_adapter(agent_output: dict) -> dict:
    ...
    action = {**base,
              "verb": verb,
              "object": obj,
              "parameters": agent_output.get("params", agent_output.get("target",{}).get("attributes", {})),
...
def anthropic_adapter(agent_output: dict) -> dict:
    base = _make_base(actor_id=agent_output.get("assistant_id","anthropic:assistant"))
    verb = agent_output.get("intent") or agent_output.get("action") or "anthropic:unknown"
    obj = {
        "type": agent_output.get("target",{}).get("type","unknown"),
        "id": agent_output.get("target",{}).get("id",""),
        "attributes": agent_output.get("target",{}).get("attributes",{})
    }
    return {**base,
            "verb": verb,
...
def google_gemini_adapter(agent_output: dict) -> dict:
    ...
    obj = {"type": entity.get("type","unknown"), "id": entity.get("id",""), "attributes": entity.get("attributes", {})}
    return {**base,
            "verb": verb,
            "object": obj,
            "parameters": entity.get("attributes", {}),
            "confidence": float(agent_output.get("score", agent_output.get("confidence", 0.0)) or 0.0),
            "reasoning": agent_output.get("why",""),
            "policy_evaluation": agent_output.get("policy",{}),
            "metadata": agent_output.get("meta",{})}

def llama_adapter(agent_output: dict) -> dict:
    ...
    obj = {"type": target.get("type","resource"), "id": target.get("id",""), "attributes": target.get("attributes", {})}
    return {**base,
            "verb": verb,
            "object": obj,
...
def openai_tools_adapter(agent_output: dict) -> dict:
    ...
    obj = {"type": args.get("object_type","resource"), "id": args.get("id",""), "attributes": args}
    return {**base,
            "verb": verb,
            "object": obj,
            "parameters": args,
            "confidence": float(agent_output.get("confidence", 0.0) or agent_output.get("score", 0.0) or 0.0),
            "reasoning": agent_output.get("explanation",""),
            "policy_evaluation": agent_output.get("policy",{}),
            "metadata": agent_output.get("meta",{})}

def react_adapter(agent_output: dict) -> dict:
    ...
    obj = {"type": input_.get("object_type","resource"), "id": input_.get("id",""), "attributes": input_}
    return {**base,
            "verb": verb,
            "object": obj,
            "parameters": input_,
            "confidence": float(agent_output.get("confidence", 0.0) or 0.0),
            "reasoning": agent_output.get("chain_of_thought", agent_output.get("reason","")),
            "policy_evaluation": agent_output.get("policy",{}),
            "metadata": agent_output.get("meta",{})}
